      ...
      <Link to={`/product/${props.id}`} className={`col-lg-${props.col} col-md-6 col-12`}>
        ...
        <div className="m-1 border rounded p-3 h-100">
          <div className="border-bottom pb-3">
            <p style={{ color: "gray",fontSize: "22px"}}> {StringSlice(props.title,15)}</p>
            <p>{StringSlice(props.description,15)}</p>
            <div className="px-5 py-4 position-relative" style={{height:"100%"}}>
              {props.sale &&(<p
            ...
            sale
              ...
              <img
                src={"https://backend-e-commerce-production-25ff.up.railway.app"+props.img}
                alt=".."
                className="img-fluid"
              />
            </div>
